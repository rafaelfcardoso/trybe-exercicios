...
Logo, adicione na função sendMarsTemperature uma callback que contenha as ações a serem tomadas em cima da temperatura. */
...
const sendMarsTemperature = (onSuccess) => {
  ...
  setTimeout(() => onSuccess(marsTemperature), messageDelay());
};
